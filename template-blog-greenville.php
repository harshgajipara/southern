    ...
    <div class="container">
        <div class="blog-latest-news">
            <div class="blog-latest-news-top">
                <h2 class="southern-title">Featured articles</h2>
                <?php echo do_shortcode('[ajax_load_more container_type="div" post_type="Greenville_blog" progress_bar="true" progress_bar_color="ed7070" button_label="Loading.." posts_per_page="4"]'); ?>
            </div>
            </div>
        </div>
    </div>
