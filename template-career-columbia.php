                ...
                <?php if( have_rows('career') ): ?>
				    ...
				    <?php while( have_rows('career') ): the_row(); 
				    	...
				    	<div class="career-bottom">
		                    ...
		                    <p><a  data-toggle="collapse" data-target="#<?php echo get_row_index(); ?>" aria-controls="<?php echo get_row_index(); ?>">READ MORE</a></p>
						</div>

		                    <div data-parent="#accordion" class="collapse" id="<?php echo get_row_index(); ?>">
