<?php
/*
Template Name:Contact Columbia
*/
get_header('columbia');
?>
    	...
    	<div class="southernway-contact">
        	<div class="southernway-get-touch">
            	...
            	<div class="southernway-get-touch-bottom">
                    ...
                    <div class="southernway-get-touch-laction">
                        <a href="<?php echo site_url('/greenville'); ?>"><?php the_field('button_text','option'); ?></a>
                    </div>
                </div>                
            </div>
        </div>
        	...
        	<div class="contact-form-main">
                <div class="contact-form">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="121" title="Contact columbia"]'); ?>
                </div>            	
            </div>
        </div>
</section>
